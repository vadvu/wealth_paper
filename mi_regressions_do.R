...
write.csv(all.me, "imp_models/all.me.nvc_final.csv")
write.csv(all.coef, "imp_models/all.coef.nvc_final.csv")
write.csv(all.pred, "imp_models/all.pred.nvc_final.csv")
...
write.csv(all.coef, "imp_models/all.coef.nvc.linear_final.csv")
...
write.csv(all.me, "imp_models/all.me.rev_final.csv")
write.csv(all.coef, "imp_models/all.coef.rev_final.csv")
write.csv(all.pred, "imp_models/all.pred.rev_final.csv")
...
write.csv(all.coef, "imp_models/all.coef.rev.linear_final.csv")
